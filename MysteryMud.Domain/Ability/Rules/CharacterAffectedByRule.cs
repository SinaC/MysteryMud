...
public class CharacterAffectedByRule : AbilityValidationRule // opposite of NotAffectedByRule
{
    ...
    public CharacterAffectedByRule(AbilityValidationRuleCondition condition, AbilityValidationFailBehaviour failBehaviour, string failMessageKey, CharacterEffectTagId effectTagId)
