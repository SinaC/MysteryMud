...
public sealed class CombatOrchestrator
{
    ...
    public CombatOrchestrator(IGameMessageService msg, IIntentContainer intents, HitResolver hitResolver, HitDamageFactory hitDamageFactory, DamageResolver damageResolver, WeaponProcResolver weaponProcResolver, ReactionResolver reactionResolver)
    {
        _intents = intents;
