...
public class CommandThrottleSystem
{
    ...
    private static readonly QueryDescription _hasCommandQueryDescr = new QueryDescription()
    ...
    public void Execute(GameState state)
    {
        ...
        _world.Query(_hasCommandQueryDescr, (EntityId player,
            ref CommandBuffer buffer,
            ref CommandThrottle throttle,
            ref PlayerTag _,
            ref HasCommandTag _) =>
        {
