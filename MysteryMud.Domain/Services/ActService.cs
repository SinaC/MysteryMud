...
public class ActService : IActService
{
    ...
    private static void FormatActOneArgument(Entity target, StringBuilder sb, int argumentIndex, ReadOnlySpan<char> argumentFormat, object? argument)
    {
        ...
        if (argument is Entity character && character.Has<CharacterTag>())
        {
            ...
            switch (letter)
            {
                case 'p':
                    ...
                    else AppendPossessive(sb, RelativeDisplayName(character, target));
                    break;
                case 'P':
                    if (target == character) sb.Append("Your");
                    else AppendPossessive(sb, RelativeDisplayName(character, target), true);
                    break;
                case 'n':
                    sb.Append(target == character ? "you" : RelativeDisplayName(character, target));
                    break;
                case 'N':
                    sb.Append(target == character ? "You" : RelativeDisplayName(character, target).FirstCharToUpper());
                    break;
                case 'e':
                ...
                case 'y':
                    if (target == character) sb.Append("your");
                    else sb.Append(RelativeDisplayName(character, target)).Append("'s");
                    break;
                case 'Y':
                    if (target == character) sb.Append("Your");
                    else sb.Append(RelativeDisplayName(character, target)).Append("'s");
        ...
        if (argument is Entity item && item.Has<ItemTag>())
        {
            ...
            {
                case 'p':
                    AppendPossessive(sb, RelativeDisplayName(item, target));
                    break;
                case 'P':
                    AppendPossessive(sb, RelativeDisplayName(item, target), true);
                    break;
                case 'n':
                    sb.Append(item.DisplayName);
                    break;
                case 'N':
                    sb.Append(RelativeDisplayName(item, target).FirstCharToUpper());
                    break;
                case 'e':
                ...
                case 'F':
                    ...
                    break;
                case 'y':
                    sb.Append(RelativeDisplayName(item, target)).Append("'s");
                    break;
                case 'Y':
                    sb.Append(RelativeDisplayName(item, target)).Append("'s");
                    break;
    ...
    private static string RelativeDisplayName(Entity entity, Entity observer)
    {
        // TODO
