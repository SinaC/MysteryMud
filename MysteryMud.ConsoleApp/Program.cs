...
services.AddSingleton(sp => new EffectiveResourceRegenSystem<HealthRegen, DirtyHealthRegen, HealthRegenModifier>(x => x.BaseAmountPerSecond, x => x.CurrentAmountPerSecond, (ref x, v) => x.CurrentAmountPerSecond = v, x => x.Modifier, x => x.Value));
services.AddSingleton(sp => new EffectiveResourceRegenSystem<ManaRegen, DirtyManaRegen, ManaRegenModifier>(x => x.BaseAmountPerSecond, x => x.CurrentAmountPerSecond, (ref x, v) => x.CurrentAmountPerSecond = v, x => x.Modifier, x => x.Value));
services.AddSingleton(sp => new EffectiveResourceRegenSystem<EnergyRegen, DirtyEnergyRegen, EnergyRegenModifier>(x => x.BaseAmountPerSecond, x => x.CurrentAmountPerSecond, (ref x, v) => x.CurrentAmountPerSecond = v, x => x.Modifier, x => x.Value));
services.AddSingleton(sp => new EffectiveResourceRegenSystem<RageDecay, DirtyRageDecay, RageDecayModifier>(x => x.BaseAmountPerSecond, x => x.CurrentAmountPerSecond, (ref x, v) => x.CurrentAmountPerSecond = v, x => x.Modifier, x => x.Value));
